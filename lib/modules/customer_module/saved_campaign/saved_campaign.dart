...
class SavedCampaign extends StatefulWidget {
  SavedCampaign({super.key});

  @override
  State<SavedCampaign> createState() => _SavedCampaignState();
}

class _SavedCampaignState extends State<SavedCampaign> {
